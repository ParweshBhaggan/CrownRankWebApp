...
const draft = { firstName: 'Ada', lastName: 'Lovelace', username: 'ada', category: 'technology', contribution: 12.5, socialLinks: [{ id: '1', platform: 'instagram', url: 'https://www.instagram.com/ada' }] }
