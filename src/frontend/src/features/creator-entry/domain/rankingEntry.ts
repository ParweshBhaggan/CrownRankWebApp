...
export interface RankingEntryDraft { readonly firstName: string; readonly lastName: string; readonly username: string; readonly category: CreatorCategory; readonly socialLinks: readonly SocialLinkInput[]; readonly profileImage?: File; readonly contributionCents: number }
