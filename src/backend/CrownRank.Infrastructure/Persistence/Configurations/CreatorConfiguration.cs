...
internal sealed class CreatorConfiguration : IEntityTypeConfiguration<Creator>
{
    public void Configure(EntityTypeBuilder<Creator> builder)
    {
        ...
        builder.Property(creator => creator.Location).HasMaxLength(120);
        ...
        builder.HasMany(creator => creator.Contributions).WithOne().HasForeignKey(contribution => contribution.CreatorId).OnDelete(DeleteBehavior.Cascade);
